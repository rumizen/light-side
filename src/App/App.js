        ...
        <Route
          ...
          render={() => (
            <section className="landing-page">
              <div className="emperor-img">
                <img
                  src="https://cdn.dribbble.com/users/35682/screenshots/2507121/dribble-good-josephle.gif"
                  alt="Emporer Palpatine"
                />
              </div>
              <h2>
                Welcome to the DarkSide! Let your curiousity flow through
                you and select a catagory for more information.
              </h2>
            </section>
          )}
        />
